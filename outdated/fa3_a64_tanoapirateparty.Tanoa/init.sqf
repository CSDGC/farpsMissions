...
// ====================================================================================
sleep 0.5;
//set texture on applicable units
if ((uniform player) == "U_B_GEN_Soldier_F") then {
	[player,[0,"\A3\Characters_F_Exp\Syndikat\Data\U_I_C_Soldier_Para_3_F_1_co.paa"]] remoteExec ["setObjectTexture",0,true];
	[player,[1,"\a3\characters_f\BLUFOR\Data\clothing_wdl_co.paa"]] remoteExec ["setObjectTexture",0,true];
};
