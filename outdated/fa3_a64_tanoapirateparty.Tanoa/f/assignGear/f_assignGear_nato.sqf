...
_glmaglarge = "1Rnd_HE_Grenade_shell";
...
// Backpacks
_bag = selectRandom ["B_AssaultPack_rgr","B_AssaultPack_khk"];
...
_baseHelmet = ["H_Bandanna_camo","H_Bandanna_gry","H_Watchcap_sgg","H_Watchcap_blk","H_Cap_oli_hs","H_Cap_blk"];
_baseGlasses = [];

// Vests
_lightRig = ["V_Chestrig_oli","V_Chestrig_rgr"];
