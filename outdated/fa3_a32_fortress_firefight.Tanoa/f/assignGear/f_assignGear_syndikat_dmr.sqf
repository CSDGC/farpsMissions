...
// Rifleman (AT) Loadout:
	...
	{
		_unit addBackpack _bag;
		_unit addmagazines ["10Rnd_762x54_Mag", 1];
		_unit addweapon "srifle_DMR_01_F";
		_unit addmagazines [_RATmag, 1];
		_unit addweapon _RAT;
		_unit addItem _firstaid;
		_unit addmagazines [_smokegrenade, 1];
		_unit addmagazines ["10Rnd_762x54_Mag", 6];
...
// Medic Loadout:
	case "m":
	{
		...
		_unit addItem _firstaid;
		_unit addmagazines [_smokegrenade, 1];
		_unit addmagazines ["10Rnd_762x54_Mag", 10];
		_unit addmagazines [_smokegrenade, 4];
...
// Medium MG Team Leader Loadout:
	case "mmgag":
	{
		...
		_unit addItem _firstaid;
		_unit addmagazines [_smokegrenade, 1];
		_unit addmagazines ["10Rnd_762x54_Mag", 4];
		_unit addmagazines ["10Rnd_762x54_Mag", 2];
		_unit addmagazines [_smokegrenade, 4];
		_unit addmagazines ["10Rnd_762x54_Mag", 1];
		_unit addmagazines ["10Rnd_762x54_Mag", 2];
