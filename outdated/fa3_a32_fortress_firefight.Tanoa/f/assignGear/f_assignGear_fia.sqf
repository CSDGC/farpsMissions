...
_scope1 = "optic_Holosight_blk_F";			// Holo
...
// Default setup
//_attachments = []; // Defined at the end of script in loadout section
...
_rifle = ["arifle_TRG20_F"]; // Carbines FOR EVERYONE huehuehue
_riflemag = "30Rnd_556x45_Stanag_red";
_riflemag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["arifle_TRG20_F"]; // Carbine
_carbinemag = "30Rnd_556x45_Stanag_red";
_carbinemag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// thought of a simple way of changing weapons on per loadout basis, unfortunately only after I'd done the first 4 loadouts.
// _gun is the gun given to every player in the fia_custom loadout script.
_gun = switch (f_param_loadouts) do {
	case 0:{"hgun_PDW2000_F"};
	case 1:{"hgun_PDW2000_F"};
	case 2:{"hgun_PDW2000_F"};
	case 3:{"hgun_PDW2000_F"};
	case 4:{"hgun_PDW2000_F"};
	case 5:{"srifle_LRR_tna_F"};
	default{"hgun_PDW2000_F"};
};

_gunmag = switch (f_param_loadouts) do {
	case 0:{"30Rnd_9x21_Mag"};
	case 1:{"30Rnd_9x21_Mag"};
	case 2:{"30Rnd_9x21_Mag"};
	case 3:{"30Rnd_9x21_Mag"};
	case 4:{"30Rnd_9x21_Mag"};
	case 5:{"7Rnd_408_Mag"};
	default{"hgun_PDW2000_F"};
};
...
_glrifle = ["arifle_TRG21_F"]; // Slight randomization, biased towards TRG_glriflemag = "30Rnd_556x45_Stanag_red";
...
_heavyHelmet = ["H_RacingHelmet_1_blue_F"]; // define helmet for COD simulator loadouts
...
// MMG Loadout
if (_loadout == 3) then {
	#include "f_assignGear_fia_MMG.sqf"
	_attachments = []
};

// DMR Loadout
if (_loadout == 4) then {
	#include "f_assignGear_fia_dmr.sqf"
	_attachments = []
};

if (_loadout == 5) then {
	#include "f_assignGear_fia_custom.sqf"
	_attachments = []
};
