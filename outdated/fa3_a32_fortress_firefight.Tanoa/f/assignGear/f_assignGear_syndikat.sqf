...
_scope1 = "optic_Holosight_blk_F";			// ACO
...
// Default setup
//_attachments = []; // Defined later on according to loadouts
...
_rifle = "arifle_AKS_F"; // Slight randomization, biased towards TRG
_riflemag = "30Rnd_545x39_Mag_F";
_riflemag_tr = "30Rnd_545x39_Mag_Tracer_F";
...
_glrifle = "arifle_AKM_F"; // Slight randomization, biased towards TRG
...
_heavyHelmet = ["H_HelmetO_ViperSP_ghex_F"]; // Helmet for COD sim loadout
...
_heavyRig = ["V_PlateCarrierSpec_rgr"];
...
// MMG Loadout
if (_loadout == 3) then {
	#include "f_assignGear_syndikat_MMG.sqf"
	_attachments = []
};

// DMR Loadout
if (_loadout == 4) then {
	#include "f_assignGear_syndikat_dmr.sqf"
	_attachments = []
};
