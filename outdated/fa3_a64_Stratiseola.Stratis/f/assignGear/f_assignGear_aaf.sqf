...
_crew = ["vc","vg","vd"];
_ghillie = ["sn"];
_specOp = ["sp"]; // spotter put in here because ease of changing variables
_autoR = ["ar"];
...
// Ghillie
_ghillieUniform = ["U_I_CombatUniform_shortsleeve"];
...
_sfGlasses = ["G_Aviator","G_Shades_Black"];

// AR loadout
_arUniform = _baseUniform;
_arHelmet = _baseHelmet;
_arGlasses = _baseGlasses;
_arRig = ["V_PlateCarrierIA1_dgtl"];
