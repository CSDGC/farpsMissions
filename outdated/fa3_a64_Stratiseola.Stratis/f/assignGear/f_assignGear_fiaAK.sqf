...
_scope3 = "optic_KHS_old";			// Old Kahlia scope

_bipod1 = "bipod_03_F_blk";		// Default bipod
_bipod2 = "bipod_03_F_blk";
...
_crew = ["vc","vg","vd"];
_ghillie = ["sn"];
_specOp = ["sp"]; //spotter shoved in here for ease of changing loadout
_autoR = ["ar"];

// Basic clothing
// The outfit-piece is randomly selected from the array for each unit

_baseUniform = ["U_BG_leader","U_BG_Guerilla1_1","U_BG_Guerilla2_1","U_BG_Guerilla2_2","U_BG_Guerilla2_3","U_BG_Guerrilla_6_1"];
_baseHelmet = ["H_Shemag_olive","H_ShemagOpen_tan","H_Bandanna_khk","H_Cap_oli","H_Watchcap_blk"];
_baseGlasses = ["G_Bandanna_blk","G_Bandanna_khk","G_Bandanna_oli","G_Bandanna_aviator"];
...
// Sniper
_ghillieUniform = ["U_BG_Guerilla1_1"];
_ghillieHelmet = ["H_Booniehat_oli","H_Booniehat_khk","H_Booniehat_grn"];
_ghillieRig = ["V_BandollierB_khk","V_BandollierB_rgr","V_BandollierB_oli"];
_ghillieGlasses = ["G_Bandanna_blk","G_Bandanna_khk","G_Bandanna_oli"];

// Spec Op (actually Spotter)
_sfuniform = ["U_BG_Guerilla1_1"];
_sfhelmet = ["H_Booniehat_oli","H_Booniehat_khk","H_Booniehat_grn"];
_sfRig = ["V_Chestrig_rgr"];
_sfGlasses = ["G_Bandanna_blk","G_Bandanna_khk","G_Bandanna_oli"];

// AR loadout
_arUniform = ["U_B_CombatUniform_mcam_tshirt"]; // NATO Fatigues, Sage texture applied in unit's init to make it look more Guerilla-y
_arHelmet = _baseHelmet;
_arGlasses = _baseGlasses;
_arRig = ["V_TacVestIR_blk"];
