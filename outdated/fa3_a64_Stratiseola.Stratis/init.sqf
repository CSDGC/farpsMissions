...
// Cache spawning and text intro stole- BORROWED from Shado'
// On neither the server nor the HC
if (!isDedicated) then {
	// Display a short text intro
 	[] spawn {
	 waitUntil {time > 15};
		 ["Stratis-Eola","Some forest, Stratis"] call ws_fnc_showIntro;
	};// Display a short text intro
};

//------------------------------------------------------------------------------
// Call cache script - handles cache spawning, damage and endings/notifications for cache destruction.
