...
// AAF
_garrisonIndp = ["I_C_Soldier_Para_1_F","I_C_Soldier_Para_2_F","I_C_Soldier_Para_7_F"];
...
_platformBuildings = [platformBlock_64,platformBlock_65];
_buildings = _buildings - _platformBuildings;
