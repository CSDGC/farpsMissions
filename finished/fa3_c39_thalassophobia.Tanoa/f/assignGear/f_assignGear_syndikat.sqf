...
_rifle = "arifle_AK12_F"; // Slight randomization, biased towards AK12
...
_baseHelmet = ["H_Beret_blk","H_Beret_blk","H_Beret_blk","H_Shemag_olive","H_Bandanna_khk","H_Bandanna_gry"];
_baseGlasses = ["G_Bandanna_blk","G_Bandanna_khk","G_Bandanna_oli"];

// Vests
_lightRig = ["V_Chestrig_blk","V_Chestrig_rgr"];
_standardRig = ["V_TacChestrig_oli_F","V_TacChestrig_grn_F","V_TacChestrig_cbr_F","V_Chestrig_rgr","V_TacVestIR_blk"];
