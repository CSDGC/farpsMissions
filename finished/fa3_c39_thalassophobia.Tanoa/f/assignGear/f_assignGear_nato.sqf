...
_rifle = "arifle_Mk20_F"; //SPAR used for heavy loadouts
_riflemag = "30Rnd_556x45_Stanag_red";
_riflemag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "SMG_02_F"; //Sting 9mm used for light and standard loadouts
_carbinemag = "30Rnd_9x21_Mag_SMG_02_Tracer_Red";
_carbinemag_tr = "30Rnd_9x21_Mag_SMG_02_Tracer_Red";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = "SMG_02_F"; //Sting 9mm used for light and standard loadouts
...
// Sniper
_SNrifle = "srifle_DMR_07_blk_F";
_SNrifleMag = "20Rnd_650x39_Cased_Mag_F";
...
_baseUniform = ["U_B_Survival_uniform"];
_baseHelmet = ["H_HelmetB_light_black"];
_baseGlasses = ["G_Balaclava_TI_G_blk_F","G_Balaclava_TI_blk_F"];

// Vests
_lightRig = ["V_TacVest_oli"];
_standardRig = ["V_PlateCarrierIA1_dgtl"];
...
// Crewman
_crewUniform = ["U_B_Survival_uniform"];
_crewHelmet = ["H_HelmetCrew_B"];
_crewRig = ["V_TacVest_oli"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["U_B_Survival_uniform"];
_ghillieHelmet = ["H_Booniehat_indp","H_Booniehat_oli"];
