...
_baseHelmet = ["H_Bandanna_khk","H_Bandanna_cbr","H_Bandanna_gry","H_Bandanna_camo","H_Bandanna_sgg","H_Watchcap_blk","H_Watchcap_khk","H_Watchcap_sgg","H_Watchcap_camo","H_Cap_oli"];
...
_standardRig = ["V_BandollierB_rgr","V_BandollierB_rgr","V_Rangemaster_belt"];
...
// Ghillie - ACTUALLY VIPER
_ghillieUniform = ["U_O_V_Soldier_Viper_F"]; //DLC alternatives: ["U_O_FullGhillie_lsh","U_O_FullGhillie_ard","U_O_FullGhillie_sard"];
_ghillieHelmet = ["H_HelmetSpecO_ghex_F"];
_ghillieRig = ["V_HarnessO_ghex_F"];
_ghillieGlasses = ["G_Aviator"];

// Spec Op
_sfuniform = ["U_O_T_Soldier_F"];
_sfhelmet = _baseHelmet;
_sfRig = ["V_HarnessOGL_ghex_F"];
_sfGlasses = [];
