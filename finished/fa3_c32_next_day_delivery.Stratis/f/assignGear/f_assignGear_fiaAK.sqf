...
// Backpacks
_bag = selectRandom ["B_AssaultPack_cbr","B_AssaultPack_rgr","B_AssaultPack_khk"];
...
//_baseHelmet = ["H_Shemag_olive","H_Shemag_olive","H_Shemag_olive","H_ShemagOpen_tan","H_ShemagOpen_tan","H_ShemagOpen_tan","H_Bandanna_khk","H_Booniehat_khk","H_Booniehat_tan","H_Bandanna_cbr","H_Bandanna_sgg","H_Hat_tan","H_Hat_brown"];
_baseHelmet = ["H_Beret_Colonel"];
_baseGlasses = ["G_Bandanna_tan","G_Bandanna_khk","G_Bandanna_oli"];

// Vests
_lightRig = ["V_TacChestrig_grn_F","V_TacChestrig_oli_F","V_TacChestrig_cbr_F"];
_standardRig = ["V_TacChestrig_grn_F","V_TacChestrig_oli_F","V_TacChestrig_cbr_F"];
...
// Crewman
_crewUniform = ["U_I_G_Story_Protagonist_F"];
