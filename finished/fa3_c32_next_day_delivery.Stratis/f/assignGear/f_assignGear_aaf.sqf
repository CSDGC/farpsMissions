...
_carbine = selectRandom [["hgun_PDW2000_F","30Rnd_9x21_Mag"],["hgun_PDW2000_F","30Rnd_9x21_Mag"],["arifle_Mk20C_F","30Rnd_556x45_Stanag"]];
...
_baseHelmet = ["H_HelmetIA","H_Booniehat_dgtl","H_Booniehat_dgtl","H_MilCap_dgtl"];
_baseGlasses = [];

// Vests
_lightRig = ["V_Chestrig_khk","V_Chestrig_rgr"];
_standardRig = ["V_TacVest_oli","V_TacVest_oli","V_Chestrig_rgr"];
