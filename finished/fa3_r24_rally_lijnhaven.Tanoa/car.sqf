...
[
	...
	{},
	{
		["Alert",["Flip Complete!"]] call BIS_fnc_showNotification;
    (_this select 0) setPos [getPos (_this select 0) select 0, getPos (_this select 0) select 1, 1];
    (_this select 0) setVectorUp [0,0,1];
	},
	{ ["Alert",["Flip Interrupted!"]] call BIS_fnc_showNotification },
	nil,
	5,
	5,
	false
