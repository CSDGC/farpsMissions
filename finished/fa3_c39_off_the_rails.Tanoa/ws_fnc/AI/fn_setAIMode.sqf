...
//Debugging - _modes shouldnt have over four entries
if (count _modes > 4) then {["ws_fnc_setAIMode DBG:",_modes,"for some reason has over four entries. Why?"] call ws_fnc_debugText;};
