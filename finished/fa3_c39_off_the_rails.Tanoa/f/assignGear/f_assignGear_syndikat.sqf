...
// WEAPON SELECTION
if (f_param_loadouts_enemy == 0) then {
	_rifle = "arifle_AKM_FL_F";
};
if (f_param_loadouts_enemy == 1) then {
	_rifle = selectRandom ["arifle_AK12_F","arifle_AKM_FL_F"]; // Slight randomization, biased towards AKM
};
...
_baseUniform = ["U_I_C_Soldier_Camo_F","U_I_C_Soldier_Para_1_F","U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Para_4_F","U_I_C_Soldier_Para_5_F"];
_baseHelmet = ["H_Beret_blk","H_Beret_blk","H_Beret_blk","H_Bandanna_khk","H_Bandanna_gry"];
_baseGlasses = ["G_Bandanna_blk","G_Bandanna_khk","G_Bandanna_oli"];

// Vests
_lightRig = ["V_TacChestrig_oli_F","V_TacChestrig_grn_F","V_TacChestrig_cbr_F","V_Chestrig_blk","V_Chestrig_rgr"];
_standardRig = ["V_TacChestrig_oli_F","V_TacChestrig_grn_F","V_TacChestrig_cbr_F","V_TacVest_oli","V_TacVest_oli","V_TacVest_khk","V_TacVest_brn","V_I_G_resistanceLeader_F"];
...
if (_isMan) then {
	...
	#include "f_assignGear_clothes_synd.sqf";
