...
_scope1 = selectRandom ["optic_MRCO","optic_ACO","optic_ACO"];			// ACO
...
// attachments defined based on loadout later
...
if (f_param_loadouts_enemy == 2) then { //heavy loadout uses either AK12 or 7.62 DMR, so select an array of the gun plus ammo, so the correct mag is given to the gun
	_gunAmmo = selectRandom [["arifle_AK12_F","30Rnd_762x39_Mag_F","30Rnd_762x39_Mag_Tracer_F"],["arifle_AK12_F","30Rnd_762x39_Mag_F","30Rnd_762x39_Mag_Tracer_F"],["srifle_DMR_06_olive_F","20Rnd_762x51_Mag","20Rnd_762x51_Mag"],["srifle_DMR_03_F","20Rnd_762x51_Mag","20Rnd_762x51_Mag"]];
	_rifle = (_gunAmmo select 0);
	_riflemag = (_gunAmmo select 1);
	_riflemag_tr = (_gunAmmo select 2);
} else {
	_rifle = selectRandom ["arifle_AK12_F","arifle_AKM_FL_F","arifle_AKM_FL_F"];
...
_nvg = selectRandom ["NVGoggles_INDEP","NVGoggles_INDEP",""];
...
_heavyUniform = ["U_I_C_Soldier_Camo_F","U_I_C_Soldier_Para_2_F"];
_baseHelmet = ["H_Beret_blk"];
_baseGlasses = ["G_Bandanna_blk","G_Bandanna_khk","G_Bandanna_oli",""];

// Vests
_lightRig = ["V_TacChestrig_grn_F","V_TacChestrig_oli_F","V_TacChestrig_cbr_F"];
_standardRig = ["V_TacVest_brn","V_TacVest_oli","V_TacVest_blk","V_TacVest_camo"];
_heavyRig = ["V_TacVestIR_blk","V_TacVestIR_blk","V_PlateCarrier1_blk"];
