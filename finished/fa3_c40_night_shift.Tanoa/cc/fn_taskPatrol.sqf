...
if (isNil "blacklistA") then {blacklistA = [blacklistArea0,blacklistArea1];}; //if blacklist area isn't defined, define it so we can pushback blacklisted areas into it
