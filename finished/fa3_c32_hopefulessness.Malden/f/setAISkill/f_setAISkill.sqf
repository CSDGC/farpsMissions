...
// RUN THE SCRIPT ONLY SERVER OR HC SIDE
...
// By waiting a few seconds into the mission the server is giving time to settle and it ensures that the component catches AI created during init
