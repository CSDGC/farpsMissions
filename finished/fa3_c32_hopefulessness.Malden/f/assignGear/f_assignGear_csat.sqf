...
_scope2 = "optic_ARCO_blk_F";			// MRCO Scope - 1x - 6x
...
_carbine = selectRandom [["arifle_CTAR_blk_F","30Rnd_580x42_Mag_F"],["arifle_CTAR_blk_F","30Rnd_580x42_Mag_F"],["SMG_02_F","30Rnd_9x21_Mag"]];
...
// Backpacks
_bag = "B_Messenger_Coyote_F";			// carries 120, weighs 20
...
// Woodland-Hex
_baseUniform = ["U_I_C_Soldier_Para_1_F","U_I_C_Soldier_Para_5_F","U_I_C_Soldier_Para_5_F","U_I_C_Soldier_Para_5_F","U_I_C_Soldier_Bandit_3_F","U_IG_leader","U_IG_Guerilla1_1","U_IG_Guerilla2_3","U_IG_Guerrilla_6_1"];
_baseHelmet = ["H_Shemag_olive","H_Shemag_olive_hs","H_ShemagOpen_tan"];
...
// Vests
_lightRig = ["V_LegStrapBag_coyote_F","V_LegStrapBag_olive_F"];
_standardRig = ["V_LegStrapBag_coyote_F","V_LegStrapBag_olive_F","V_TacVest_khk","V_TacVest_oli"];
...
// Diver
_diverUniform =  ["U_O_CombatUniform_ocamo"];
_diverHelmet = ["H_Watchcap_khk","H_Watchcap_cbr","H_Watchcap_camo"];
_diverRig = ["V_HarnessO_brn"];
_diverGlasses = ["G_WirelessEarpiece_F"];
