...
// Marksman rifle
_DMrifle = "arifle_RPK12_F";
_DMriflemag = "30Rnd_762x39_Mag_F";
...
_baseUniform = ["U_B_CombatUniform_mcam","U_B_CombatUniform_mcam","U_B_CombatUniform_mcam_vest","U_B_CombatUniform_mcam_vest","U_B_CombatUniform_mcam_vest"];
_baseHelmet = ["H_PASGT_basic_olive_F"];
_baseGlasses = [];

// Vests
_lightRig = ["V_TacVest_oli"];
_standardRig = ["V_PlateCarrierIAGL_oli"];
...
_crewRig = ["V_PlateCarrierSpec_rgr"];
_crewGlasses = ["G_Balaclava_combat"];
...
if (_isMan) then {
	...
	[_unit,[0,"\a3\characters_f\BLUFOR\Data\clothing_sage_co.paa"]] remoteExec ["setObjectTexture",0,true];
